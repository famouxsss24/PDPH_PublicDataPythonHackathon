...
**MVP 전체 완성 (2026-07-07).** 파이프라인 01~04 실행 완료, 웹 UI 전면 리디자인, 타임랩스 GIF 산출, end-to-end 브라우저 검증까지 끝. **다음 = S-DoT 검증(05) 또는 가산기능(그늘막·SDI).**
...
- 지도 클릭 2번 = 경로. **공유링크**: `/?from=37.654,127.056&to=37.648,127.070`
- 좌측 카드: 시간대 세그먼트·▶타임랩스·β 슬라이더·그림자/격자 토글
